    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath}/student">Học sinh</a>
    ...
    <table class="table table-hover">
        ...
        <c:forEach var="student" items="${students}" varStatus="status">
            <tr>
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/student?action=edit&id=${student.id}" class="btn btn-warning">edit</a>
